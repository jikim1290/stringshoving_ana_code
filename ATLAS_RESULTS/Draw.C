{
 ...
 gdata_v22_pT->GetYaxis()->SetTitle("v_{2,2}(#font[12]{p}_{T}^{a},#font[12]{p}_{T}^{b})");
 gdata_v22_pT->GetXaxis()->SetTitle("#font[12]{p}_{T}^{a} (GeV/c)");
 ...
 leg->AddEntry( (TObject*)0, "0.5<#font[12]{p}_{T}^{b}<5.0, #font[12]{N}_{ch}, ATLAS Template fit","");
 ...
 gdata_v22_mult->GetXaxis()->SetTitle("#font[12]{N}_{ch}");
 ...
 leg2->AddEntry( (TObject*)0, "0.5<#font[12]{p}_{T}^{a,b}<5.0, ATLAS Template fit","");
