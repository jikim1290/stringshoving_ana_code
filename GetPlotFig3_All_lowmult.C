...
int MultMin[nMult] = {0};
int MultMax[nMult] = {40};

const int nBin_for_ntrig = 50;

void GetPlotFig3_All_lowmult(){
 ...
 for(int f=0;f<nfiles;f++){
        fin = new TFile(Form("./data/output_set%02d_grp%03d_ana5.root",set_num[f],grp_num[f]),"read");
...
/*
 ...
 c1->Divide(1,2);
 c1->cd(1); SetStyle(hC[0][0][3]); hC[0][0][3]->Draw("surf1");
 c1->cd(2); SetStyle(hC[5][0][3]); hC[5][0][3]->Draw("surf1");
*/
}
